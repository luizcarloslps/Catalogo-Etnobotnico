            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        <h2><i class="fa fa-leaf bg-green"></i>Área de atuação</h2>
                    </div><!-- end col -->
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper">
                            <div class="blog-title-area">
                                <h3>EEEI Severino Moreira Barbosa.</h3>

                            </div><!-- end title -->

                            <div class="single-post-media">
                                <img src="src/img/escola_severino.jpg" alt="" class="img-fluid">
                            </div><!-- end media -->

                            <div class="blog-content">  
                                <div class="pp">
                                A EEEI SEVERINO MOREIRA BARBOSA é uma escola Estadual de período Integral. <br>Localizada em Cachoeira Paulista.
                                <h4>Localização</h4>
                                Endereço: AVENIDA DEOCLECIANO DA SILVA AZEVEDO 333<br>
                                Bairro: CENTRO<br>
                                CEP: 12630000<br>
                                Telefone: (12) 31011479<br>
                                FAX: (12) 31011479<br>
                                Email: E013171A@SEE.SP.GOV.BR<br>
                                Municipio: Cachoeira Paulista<br>
                                UF: São Paulo<br>
                                Região: Sudeste<br>
                                Mesorregião: Vale do Paraíba Paulista<br>
                                Microrregião: Guaratinguetá<br>
                                Localizacao: Urbana<br>
                                </div><!-- end pp -->
                            </div><!-- end content -->
                        </div><!-- end link-widget -->
                    </div><!-- end widget -->
